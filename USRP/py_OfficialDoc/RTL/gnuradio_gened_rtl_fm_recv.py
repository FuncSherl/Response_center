...
# Title: Top Block
# Generated: Sat Oct 20 21:03:34 2018
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
            1, samp_rate, 250e3, 100e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 250e3, 100e3, firdes.WIN_HAMMING, 6.76))
